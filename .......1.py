...
ki12 = LINETCR.LINE()
ki12.login(token="EsxmCwlSuF8aCB6phYte.ftlbF89zcBLoeX9VVVZNZG.PL0/oh9THqHoWx9RiJfxKmgwSHoLaEQ5MCkMTYf0FpM=")
ki12.loginResult()
...
#----------------------------------------------
       ...
       #             ki11.sendMessage(msg)
                ...
                ki9.sendText(msg.to,ki9mid)
                ki10.sendText(msg.to,ki10mid)
                ki11.sendText(msg.to,ki9mid)
                ki12.sendText(msg.to,ki10mid)
            elif "TL:" in msg.text:
	...
	if op.type == 11:
        ...
        if op.type == 5:
            if wait["autoAdd"] == True:
                ...
                c.contentMetadata={'mid':'u78643d09e42a36836a17cc918963a8b7'}
