...
bisa menumbuhkan perasaanku
yang lama telah hilang
dan Cinta ini begitu dalam padamu
begitu tulus padamu, 
begitu indah kurasakan padamu.
...
admin=["u19a6336222efe94acce1b05dd39c0940","u01b2ff163ce9f74b28c469f6046db80f"] 
...
─͜͡✫ Aku Ga Jawab PM Karna aq Cuma Bot Protect ─͜͡✫
─͜͡✫ ✮Ŧ€Äm ÄυŦĦōя bōŦ✮ ─͜͡✫
...
─͜͡✫ ✮Ŧ€Äm ÄυŦĦōя bōŦ✮ ─͜͡✫
─͜͡✫ NO BAPER SMULE ─͜͡✫
─͜͡✫ ECES BE SINGER ─͜͡✫
─͜͡✫ BLACK DRAGOND KICKER ─͜͡✫


Minat? Silahkan PM!
Idline: http://line.me/ti/p/~azhura07_""",
    "lang":"JP",
...
#--------------------------------
    ...
    #--------------- SC Add Admin ---------
              ...
              if admin == []:
                  ...
                  mc = "─͜͡✫Admin ✮Ŧ€Äm ÄυŦĦōя bōŦ✮─͜͡✫\n╬════════════╬\n"
                  for mi_d in admin:
    ...
    #-----------------=Selesai=------------------
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
              ...
              if msg.from_ in admin:
                md = "─͜͡✫Status Proteksi─͜͡✫\n╬══════════╬\n"
                if wait["Protectgr"] == True: md+="─͜͡✫Protect QR [On]\n"
                else: md+="─͜͡✫Protect QR [Off]\n"
                if wait["Protectcancl"] == True: md+="─͜͡✫Protect Invite [On]\n"
                else: md+="─͜͡✫Protect Invite [Off]\n"
                if wait["contact"] == True: md+="─͜͡✫Contact [On]\n"
                else: md+="─͜͡✫Contact [Off]\n"
                if wait["autoJoin"] == True: md+="─͜͡✫Auto Join [On]\n"
                else: md +="─͜͡✫Auto Join [Off]\n"
                if wait["autoCancel"]["on"] == True:md+="─͜͡✫Group Cancel " + str(wait["autoCancel"]["members"]) + "\n"
                else: md+= "─͜͡✫Group Cancel [Off]\n"
                if wait["leaveRoom"] == True: md+="─͜͡✫Auto Leave [On]\n"
                else: md+="─͜͡✫Auto Leave [Off]\n"
                if wait["timeline"] == True: md+="─͜͡✫Share [On]\n"
                else:md+="─͜͡✫Share [Off]\n"
                if wait["autoAdd"] == True: md+="─͜͡✫Auto Add [On]\n"
                else:md+="─͜͡✫Auto Add [Off]\n"
                if wait["commentOn"] == True: md+="─͜͡✫Comment [On]\n"
                else:md+="─͜͡✫Comment [Off]\n╬══════════╬\n✮Ŧ€Äm ÄυŦĦōя bōŦ✮\n╬══════════╬"
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "─͜͡✫Di Read Oleh─͜͡✫%s\n||By : ✮Ŧ€Äm ÄυŦĦōя bōŦ✮─͜͡✫\n\n>Pelaku CCTV<\n%s-=CCTV=-\n•Bintitan\n•Panuan\n•Kurapan\n•Kudisan\n\nAmiin Ya Allah\n[%s]" % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ketik Cctv dulu Peak\nBaru Ketil Ciduk\nDASAR PIKUN ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","Pasukan","Join kuy"]:
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye Team","Kabur all","Kaboor all"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bot out","Team bye"]: # Keluar Dari Semua Group Yang Di dalem nya  ada bot(Kalo Bot Kalian Nyangkut di Group lain :D)
              if msg.from_ in owner:
                 gid = cl.getGroupIdsJoined()
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                ke.sendText(msg.to,"✮✮✮✮✮✮✮✮✮")
                ku.sendText(msg.to,"✮✮✮✮✮✮✮✮✮✮")
                cl.sendText(msg.to,"Semua Udah Hadir Boss\nSiap Protect Group\nAman Gak Aman Yang Penting Croot\n\nsᴜᴘᴘᴏʀᴛᴇᴅ ʙʏ\n✮Ŧ€Äm ÄυŦĦōя bōŦ✮\nOwner: line.me/ti/p/~~azhura07_")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"╬══════════════╬")
              cl.sendText(msg.to,"Itu Creator Kami Yang Pea\nOrangnya baik kok,suka baperin cewek²\nNikung juga boleh kok asal jangan tajam")
                
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Woy","istri","Woi","woi","bot","Bot"]:
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          satpam.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ✮Ŧ€Äm ÄυŦĦōя bōŦ✮\n\nId smule\nEBS_nHaaA__\nEBS_nHaa\nNBS_VAMPIRE_EBS")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ✮Ŧ€Äm ÄυŦĦōя bōŦ✮\nStatus Boss udah Kami Like\nOwner Kami :\nline.me/ti/p/~~azhura07_")
                    print "Like"
                except:
                    pass
            else:
