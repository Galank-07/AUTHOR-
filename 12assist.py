...
acil = LINETCR.LINE()
acil.login(token="EsewVjyx69Gr3htmwQh0.gAyZyIlV6uRm4BbD05Wjqa.HaZmR3H1EbFdarRqWC4PpL35mc6dqaxO5JAyUfVXchA=")
acil.loginResult()
...
ki2= LINETCR.LINE()
ki2.login(token="ErhAtQ4JvgPhKwwZ9ny3.eYIoClpI2sl2hRSJw7q6SW.nGLKANrLMnjcKKtNcAVadsZdsiInT6gQ2cx4+VADGjM=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EsSdZkIwP9zwSBRNoEd8.LetmZ3b3S8xsvXte6ExxAa.a7UMlKmIG+CDyIsEkGp3wyJHwbAvxoP4+yXK0dzR0ac=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EsGMT1qrLV6Ye8ZlB96a.WQ7xJwYTy17gLrjSzVBpMG.3++e78JBAj7AoOLcRDFgcdf+43JIhSdYXqmOnrQbEro=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="Esj7ITWsp344qJsVE5s1.nOupgXlVxmye1W5yKNF/8q.EMvo+rI2X2T3QeJw1QwqxjqfKVbCGO5kNr1VNV39FSo=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="EsF0wRBSYvXmCySI93t1.ccBRnlJ52qxGddbmnGz+iq.XLsL3TTEijaW4ptvjrmFg4AAyOxnFWJXCLYdZST19lQ=")
ki6.loginResult()

ki7 = LINETCR.LINE()
ki7.login(token="EsHsDL5XUdYKKzUAiQj7.ZCgQGGMRGrx9nKkkfuo+rW.A9oLCG7urUwe0oJFwSe904YAjuZMwKTcSdg/CG3A7o0=")
ki7.loginResult()

ki8 = LINETCR.LINE()
ki8.login(token="EsnTKbn8bbtmIjLfj4b6.Dv033ExVwtRzpkmQ3JkPDG.9T7YeGgT9lhxAyrfWayomerklNhBgilyL6o6AljPZrk=")
ki8.loginResult()

ki9 = LINETCR.LINE()
ki9.login(token="EsoQOMjWguZcSA4HbJAb.qaw5y8Mf18Zg7MWUSHAtEW.1G2Uzz3uAD5PTBpYr3oA1t0iEZBho0kQbGUR8pjZtGY=")
ki9.loginResult()

ki10 = LINETCR.LINE()
ki10.login(token="EsGShC3iRf0hq6YenN5f.8/vGPiBoM/ZcB4S2oYc0tW.c4gxTS4rQOj3b9r/pJ4mKqCiC5rrxCjHpSbsIqxVLiM=")
ki10.loginResult()

ki11 = LINETCR.LINE()
ki11.login(token="EsdmNb1Au2vj2pDa8p88.yShUITzJjuINW9CsoWQVca.L3+OBWq1FevUiAq5rlH40p+NcIRhT/rVtZYsQD5uwV=")
ki11.loginResult()
...
╚══╩══════╝
"""
KAC=[acil,ki,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,ki10,ki11,ki12]
...
ki11mid = ki9.getProfile().mid
ki12mid = ki10.getProfile().mid
Bots=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,ki10mid,ki11mid,ki12mid]
