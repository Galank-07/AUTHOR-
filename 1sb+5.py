...
acil = LINETCR.LINE()
acil.login(token="Es0qfZH9ErrQ1d0Plehc.EiU0U3H/ifOcEyRhHc8L+a.tkuc6Dkf7AfDuYIWsyhouaqA+Qf4O1Zql5mCepqhkX8=")
acil.loginResult()
...
#=====================================================================================   
                ...
                acil.sendMessage(msg)
                msg.contentType = 13
                msg.contentMetadata = {'mid': 'u01b2ff163ce9f74b28c469f6046db80f'}
                acil.sendMessage(msg)
                acil.sendText(msg.to,"❂••••••••✰•✰••••••••❂\n\n✮Follow IG✮\nhttps://www.instagram.com/galank_nhaa/\nhttps://www.instagram.com/nhaacabbii/\n\nId SMULE:\nNBS_VAMPIRE_EBS\nEBS_nHaaA__\nEBS_nHaa\n\nADD FOR LINE:\nline.me/ti/p/~azhura07_\nline.me/ti/p/~Iechand25\n\nsᴜᴘᴘᴏʀᴛᴇᴅ ʙʏ\n✮Ŧ€Äm ÄυŦĦōя bōŦ✮\nThanks for add Gend!!")
