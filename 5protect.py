...
cl.login(token='EqA0m2PFQROjKiWo9yX8.HuUm1h/UuO3MPfskq3iZYa.5x6Rxc6/EUFjkvq49u57eDDUkEFA02yXou+XdMVXBoE=')
cl.loginResult()

ki = LINETCR.LINE() #Zorro
ki.login(token='EqZS0M3dMbjSEsJN2kfe.wvhydD8HlswGsvWpinOaVG.DFHZItyrV7X885tlDkZtFQSRfqTiOmXRpUjg0/hzKuM=')
ki.loginResult()

kk = LINETCR.LINE() #Sanji
kk.login(token='EqDGyThiFayWsE6EhUt1.nOupgXlVxmye1W5yKNF/8q.3J6ujA9ZDLS5SxWWZtBBJv/+m5c1XuNtkLkRAzguBVY=')
kk.loginResult()

kc = LINETCR.LINE() #Ussop
kc.login(token='EqKClGpHQOFAWjdZyND3.eYIoClpI2sl2hRSJw7q6SW.wtiLGs6YX1rvPINKhxN84vHTHS6+jGYZt5lQYnpjtfo=')
kc.loginResult()

ks = LINETCR.LINE() #Chooper
ks.login(token='Eqa6VZ99eFiVTWRDI6Oa.WQ7xJwYTy17gLrjSzVBpMG.WUjM6iCOTSmLEE1kMFGct3yXjhevvYnZVJYgDysW490=')
ks.loginResult()
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Cctv dulu Kampret\nBaru Ketil Ciduk\nDASAR PIKUN ♪")
#-----------------------------------------------
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Kang Sange On")
                ki.sendText(msg.to,"Kang Desah On")
                kk.sendText(msg.to,"Kang Colmek On")
                kc.sendText(msg.to,"Kang Coli On")
                ks.sendText(msg.to,"Kang Crot On")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"======================")
              cl.sendText(msg.to,"Itu Creator Kami Yang Super Kece\nTapi ngangenin emang v:")
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ❂͜͡Ĝα₤αηĸ➣👈\n\nŦ€Äm ÄυŦĦōя bōŦ")
