...
creator=["u19a6336222efe94acce1b05dd39c0940"]
admin=["u19a6336222efe94acce1b05dd39c0940",mid,Amid,Bmid,Cmid,Dmid]#,Smid] Krisna,kris,
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["One piece","Team bot","Bot"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
            ...
            elif "Ready bro" in msg.text:
              if msg.from_ in owner:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Ready bro","")
                    gs = cl.getGroup(msg.to)
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
                    gs = kc.getGroup(msg.to)
...
#----------------------------[Spam To Contact]----------------------------#WORK 
       #--------------------Start-----------------------#       
                ...
                jawab = ("Nhaa􀜁�","Aurel􀜁�","Ell􀜁�","Ridha􀜁�","Vitha􀜁�","Feii􀜁�","Prily􀜁�")
                jawaban = random.choice(jawab)
                cl.sendText(msg.to,jawaban)
                ...
                jawab = ("Ĝα₤αηĸ􀜁�","Zii􀜁�","Maman􀜁�","Wahyu􀜁�","Dimas􀜁�","Andira􀜁�")
                jawaban = random.choice(jawab)
                cl.sendText(msg.to,jawaban)
