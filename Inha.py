...
cl = LINETCR.LINE()
cl.login(token="EqcKWN2i3LTuy337O9C8.HuUm1h/UuO3MPfskq3iZYa.kqZ+obx+crZPU8WalQ1KKD3TsZJSDyri57lv1fXygAs=")
cl.loginResult()

ki = LINETCR.LINE() 
ki.login(token="EqfF4qj1bFef2CDsOYQ3.XSuK6IiPrpgzH2ySALp2qW.FUTuY6YgLmsHd1s+GxrQORTw5LnwgecrexRk6Tx0Zqg=")
ki.loginResult() 

kk = LINETCR.LINE()
kk.login(token="EqGsS3OltHZzfNpByxb6.5IPkUPKSEMU6A5/ZDHBjXG.NuEuWLvnVvImL5HG8moYXYMMHgR5oySqmnJqIul5E84=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Eql2dc10e9Xi4f1Rf2x1.nOupgXlVxmye1W5yKNF/8q.of3r6VsbLwHgKoSuPqEnCirgxOfgqRa5op6mx0oyYIM=")
kc.loginResult() 
...
satpam = LINETCR.LINE() 
satpam.login(token="Eq86CyWc6Nv0Djywhk4a.WQ7xJwYTy17gLrjSzVBpMG.w1/bwsbBPw/IzAJjRO1r8rMQR5vkq/9pzQ/oaOk5q+A=")
satpam.loginResult() 
...
creator=["u19a6336222efe94acce1b05dd39c0940"]
admin=["u19a6336222efe94acce1b05dd39c0940","u01b2ff163ce9f74b28c469f6046db80f",mid,Amid,Bmid,Cmid,Dmid,Smid] 
...
creator: line.me/ti/p/~azhura07_""",
    "lang":"JP",
    "comment":"ᗅႮᝨᝪℒⅈKℰ ✮Ŧ€Äm ÄυŦĦōя bōŦ✮     http://line.me/ti/p/~azhura07_",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
          ...
          if wait["Protectgr"] == True:
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              ...
              if op.param2 in admin:
                ...
                try:
                  cl.sendText(op.param1,cl.getContact(op.param2).displayName + "Jangan Buka Kode QR Njing...!!!")
                  cl.kickoutFromGroup(op.param1,[op.param2])
                  X = cl.getGroup(op.param1)
                  X.preventJoinByTicket = True
                  cl.updateGroup(X)
                except:
                  random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "Jangan Buka Kode QR Kampret...!!!")
          ...
          if wait["Protectcancel"] == True:
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                random.choice(KAC).sendText(op.param1, "Jangan di cancel kampret...!!!\nAdmin Bukan,Owner Juga Bukan\Kick Ah 😛")
                random.choice(KAC).kickoutFromGroup(op.param1,[op.param2]) 
...
#===========================================
        if op.type == 17:
          ...
          random.choice(KAC).sendText(op.param1, "╔═════════════\n║รεℓαɱαƭ ∂αƭαɳɠ ∂เ  " + str(ginfo.name) + "\n╠═════════════\n" + "║ƒσµɳ∂ε૨ =>>> " + str(ginfo.name) + " :\n║" + ginfo.creator.displayName + "\n╠═════════════\n" + "║😊 รεɱσɠα ɓεƭαɦ ყααα 😘 \n╠═════════════\n║ɳσ ɓαρε૨, ɳσ ɳαҡαℓ , ɳσ ɳɠεყεℓ ya..!! \n╚═════════════")
          print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "╔═════════════\n║ҡσφ ℓεαѵε รเɦ :v \n╠═════════════\n| ρα∂αɦαℓ ɓℓɱ ɱเɳƭα ραρ ɳαҡε∂ 😭 \n╚═════════════")
...
#===============================================
	      ...
	      if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "loading.......Njing............")
                time.sleep(0.03)
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Sayang","Team","Kuy join"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Team go all","Pulang all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
            ...
            elif "Crot ah" in msg.text:
              if msg.from_ in owner:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Crot ah","")
                    gs = cl.getGroup(msg.to)
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
                    gs = kc.getGroup(msg.to)
...
#--------------------------------------------------------
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
              ...
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "Requesting...Kampret...")
                time.sleep(0.002)
                elapsed_time = time.time() - start
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendMessage(msg)
              cl.sendText(msg.to,"╬═══════════════╬")
              cl.sendText(msg.to,"Itu Creator Kami Yang Ganteng Dan Ngangenin 😜\nBisa Di Tikung Kok,Kan Lagi Promo v:")  
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Woy","nhaa","nha","woi"]:
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By Ŧ€Äm ÄυŦĦōя bōŦ\n\n✮Ŧ€Äm ÄυŦĦōя bōŦ✮\nąµţ๏ℓɨЌ€ by ❂͜͡Ĝα₤αηĸ➣ ⭐👈 »»» http://line.me/ti/p/~azhura07_ «««")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By Ŧ€Äm ÄυŦĦōя bōŦ\n\n✮Ŧ€Äm ÄυŦĦōя bōŦ✮\nąµţ๏ℓɨЌ€ by ❂͜͡Ĝα₤αηĸ➣ ⭐👈 »»» http://line.me/ti/p/~azhura07_ «««")
                    ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By Ŧ€Äm ÄυŦĦōя bōŦ\n\n✮Ŧ€Äm ÄυŦĦōя bōŦ✮\nąµţ๏ℓɨЌ€ by ❂͜͡Ĝα₤αηĸ➣ ⭐👈 »»» http://line.me/ti/p/~azhura07_ «««")
                    kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By Ŧ€Äm ÄυŦĦōя bōŦ\n\n✮Ŧ€Äm ÄυŦĦōя bōŦ✮\nąµţ๏ℓɨЌ€ by ❂͜͡Ĝα₤αηĸ➣ ⭐👈 »»» http://line.me/ti/p/~azhura07_ «««")
                    kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By Ŧ€Äm ÄυŦĦōя bōŦ\n\n✮Ŧ€Äm ÄυŦĦōя bōŦ✮\nąµţ๏ℓɨЌ€ by ❂͜͡Ĝα₤αηĸ➣ ⭐👈 »»» http://line.me/ti/p/~azhura07_ «««")
                    ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By Ŧ€Äm ÄυŦĦōя bōŦ\n\n✮Ŧ€Äm ÄυŦĦōя bōŦ✮\nąµţ๏ℓɨЌ€ by ❂͜͡Ĝα₤αηĸ➣ ⭐👈 »»» http://line.me/ti/p/~azhura07_ «««")
                    print "Like"
                except:
                    pass
            else:
