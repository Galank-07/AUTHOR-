...
def helpmessage():
    ...
    helpMessage =   "╔══════════════" + "\n" + \
                    ...
                    "╠ " + key + "MyVideoProfile" + "\n" + \
                    "╠ " + key + "MyCover" + "\n" + \
                    "╠ " + key + "StealContact「Tag」" + "\n" + \
                    "╠ " + key + "StealMid「Tag」" + "\n" + \
                    "╠ " + key + "StealName「Tag」" + "\n" + \
                    "╠ " + key + "StealBio「Tag」" + "\n" + \
                    "╠ " + key + "StealPicture「Tag」" + "\n" + \
                    "╠ " + key + "StealVideoProfile「Tag」" + "\n" + \
                    "╠ " + key + "StealCover「Tag」" + "\n" + \
                    ...
                    "╠ " + key + "CheckWeather「Lokasi」" + "\n" + \
                    "╠ " + key + "CheckLocation「Lokasi」" + "\n" + \
                    "╠ " + key + "InstaInfo 「User Name」" + "\n" + \
                    "╠ " + key + "InstaPost 「User Name」|「Nomer」" + "\n" + \
                    "╠ " + key + "InstaStory 「User Name」|「Nomer」" + "\n" + \
...
# Pembatas Script #
                                ...
                                client.sendMessage(to, "Check details sticker is not actived")
                            elif cmd == "unsendchat on":
                                settings["unsendMessage"] = True
                                client.sendMessage(to, "Unsend message is actived")
                            elif cmd == "unsendchat off":
                                settings["unsendMessage"] = False
                                client.sendMessage(to, "Unsend message is not actived")
                                ...
                                try:
                                    ...
                                    if settings["autoLeave"] == True: ret_ += "\n╠══[ 􂘁􀄏O􏿿􂘁􀄎N􏿿 ] Auto Leave Room"
                                    else: ret_ += "\n╠══[ 􂘁􀄏O􏿿􂘁􀄆F􏿿􂘁􀄆F􏿿 ] Auto Leave Room"
                                    if settings["autoJoinTicket"] == True: ret_ += "\n╠══[ 􂘁􀄏O􏿿􂘁􀄎N􏿿 ] Auto Join Ticket"
                                    else: ret_ += "\n╠══[ 􂘁􀄏O􏿿􂘁􀄆F􏿿􂘁􀄆F􏿿 ] Auto Join Ticket"
                                    if settings["autoRead"] == True: ret_ += "\n╠══[ 􂘁􀄏O􏿿􂘁􀄎N􏿿 ] Auto Read"
                                    else: ret_ += "\n╠══[ 􂘁􀄏O􏿿􂘁􀄆F􏿿􂘁􀄆F􏿿 ] Auto Read"
                                    if settings["autoRespon"] == True: ret_ += "\n╠══[ 􂘁􀄏O􏿿􂘁􀄎N􏿿 ] Detect Mention"
                                    else: ret_ += "\n╠══[ 􂘁􀄏O􏿿􂘁􀄆F􏿿􂘁􀄆F􏿿 ] Detect Mention"
...
# Pembatas Script #
                            	...
                            	picture = client.downloadFileURL("https://i.imgur.com/7dj6DoZ.jpg", saveAs="image.jpg")
                            	video = client.downloadFileURL("http://www.s16.saveitoffline.com/get/?i=Nr6t3sH37Hz7IAeeWqnK9nqOe1Fh121Y&u=ueio7x61FgatTnxOMWMeh1xo14ePDjKo", saveAs="video.mp4")
