...
ki2= LINETCR.LINE()
ki2.login(token="EsqQlBQAmCIJ77sVcoAa.3svWLda5Jb1maVIdRVif6G.9uDHRSm/dtQYBDIMkL9YS/QuDDbVdHT2jMOMUbjrd+A=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EsLuGYEp8iutAr13xLZ3.eYIoClpI2sl2hRSJw7q6SW.NP9U4AAxerfx6Ejvro1Gj0tLITbVhTe29BFisdOkZLg=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="Es2fBI4HIJK0ZE1CnYF8.LetmZ3b3S8xsvXte6ExxAa.w/8pzNI8R6lKc8rWlTN0hdOh89qLeRz5AP59rPAKck0=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="EsRHNl6pHgXTB5WgNY5a.WQ7xJwYTy17gLrjSzVBpMG.7FB2mWiovQzMJugEACLy/Tzr3DDsD4KcTnzc1ObnOv8=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="Es7Ti084CA7Wny0PvEM8.yShUITzJjuINW9CsoWQVca.mjf3ZQBsH167+STFdaGUqP7vPVc3t55m+t9DSbuc5FA=")
ki6.loginResult()

ki7 = LINETCR.LINE()
ki7.login(token="EssU2QiQHOyzelXqrI61.ccBRnlJ52qxGddbmnGz+iq.O5UqBd2IM7JrNaXWc0+Kus/JaFQNM2mh4W4SrOwsstY=")
ki7.loginResult()

ki8 = LINETCR.LINE()
ki8.login(token="EsuCrqMcDR9Hbto1FkV7.ZCgQGGMRGrx9nKkkfuo+rW.rx2Mkb+E/UeucaJue3I6/3aFB7wajISt6kismB3X+Mw=")
ki8.loginResult()

ki9 = LINETCR.LINE()
ki9.login(token="EssEHm4VGr4kFiTyK4B6.Dv033ExVwtRzpkmQ3JkPDG.eUfNB+t48lJUXiPfnYyuigsy9ShZYFIdAHUeL/njAj4=")
ki9.loginResult()

ki10 = LINETCR.LINE()
ki10.login(token="EsoKj1rRJkJqqkAphZpb.qaw5y8Mf18Zg7MWUSHAtEW.mJBGXQjsTqQ9RF47r4Td1Fo9UrZe2OmbBV8JfI+GiFM=")
ki10.loginResult()

ki11 = LINETCR.LINE()
ki11.login(token="EsefdNFrE3J7sX3wJfRf.8/vGPiBoM/ZcB4S2oYc0tW.XVh3QkDpdg90DOoYfKroL+OHTtGX1pGDky3+zMcGDu4=")
ki11.loginResult()
...
ki13 = LINETCR.LINE()
ki13.login(token="EscbroscUJQpYPCEb98f.5uc/9nuwMUFvh3q3+y/pVW.bi60himPK02N8zzyLI2+i6PEbIZSYVqlKMKqPm1lg74=")
ki13.loginResult()

ki14 = LINETCR.LINE()
ki14.login(token="Esw9v0QDHERZ9vGKqQfd.Bxfy2WQL1czbHwxUgnJwhq.XjZLxHKH0Xb8HhOIwkTJgGdJbBJkEPt/jfRquXZw0x0=")
ki14.loginResult()

ki15 = LINETCR.LINE()
ki15.login(token="EsMV5ySpTyF0hTHv7Kmd.eqcOXf/I1YBSHO6SuYJyJq.xtPuHK7ZBKnnsQcW/T6/sT4VH3pO2OZIZJFhW2qc/lc=")
ki15.loginResult()

ki16 = LINETCR.LINE()
ki16.login(token="EsFODbiYjCNA9yDjpMyd.lhcKlyrNzEK1xqNJSwZ7Jq.BOymfehBIpkpc/n/WS23jBpJflgYxqvC8G+9Os1Noug=")
ki16.loginResult()

ki17 = LINETCR.LINE()
ki17.login(token="EsSxJfKdY1S2GKWxFah4.qI2PZDEevvrDVi/jO+Tfza.ZJqnZCHw/KkGkb+K3pY0rsbyTpS6YRrC2xWRmyPswJM=")
ki17.loginResult()
...
ki19 = LINETCR.LINE()
ki19.login(token="EsL1If99lZ7K5sh7nV5b.97lTGVmvXjWrorbWSIp6wW.imKT/AYEdJN90GlFnhkuflegvmgOaf8+Chug2O4+eQ4=")
ki19.loginResult()
...
╚═════════════
"""
KAC=[acil,ki,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,ki10,ki11,ki12,ki13,ki14,ki15,ki16,ki17,ki18,ki19,ki20]
...
#----------------------------------------------
     ...
     #         )
                ...
                if wait["lang"] == "JP":
                    ...
                    acil.sendText(msg.to,helpset)
            elif msg.text.lower() == 'helpgroup':
                if wait["lang"] == "JP":
                    acil.sendText(msg.to,helpgroup)
                else:
                    acil.sendText(msg.to,helpgroup)
            elif ("Gn:" in msg.text):
                if msg.toType == 2:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': ki2Omid}
                ki20.sendMessage(msg)
                ki.sendText(msg.to,"AMAN TERKENDALI MYBOSS")
            elif "B1" == msg.text:
                msg.contentType = 13
                msg.contentMetadata = {'mid': kimid}
                ki.sendMessage(msg)
            ...
            try:
                if op.param3 in mid:
                    ...
                    if op.param2 in ki5mid:
                        ...
                        ki13.acceptGroupInvitationByTicket(op.param1,Ticket)
                        ki14.acceptGroupInvitationByTicket(op.param1,Ticket)
                        k1i5.acceptGroupInvitationByTicket(op.param1,Ticket)
                        ki16.acceptGroupInvitationByTicket(op.param1,Ticket)
                        ki17.acceptGroupInvitationByTicket(op.param1,Ticket)
                        ki18.acceptGroupInvitationByTicket(op.param1,Ticket)
                        ki19.acceptGroupInvitationByTicket(op.param1,Ticket)
	...
	if op.type == 11:
        ...
        if op.type == 5:
            if wait["autoAdd"] == True:
                ...
                c.contentMetadata={'mid':'u19a6336222efe94acce1b05dd39c0940'}
                acil.sendImageWithURL(op.param1,"http://dl.profile.line-cdn.net/0hXvsx4nw8B1lOASv0QGJ4DnJECTQ5LwERNmdAb2wDW25gMkNbJTNAOjtTCz1jYkELJzJKNzkAUWxi")
                if (wait["message"] in [""," ","\n",None]):
                    pass
                else:
                    ...
                    ki19.sendMessage(c)
                    ki20.sendText(op.param1,str(wait["message"]))
                    ki20.sendMessage(c)
