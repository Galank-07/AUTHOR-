...
ki1o = LINETCR.LINE()
ki19.login(token="Esv1rcD3jpXwO0uYV96b.97lTGVmvXjWrorbWSIp6wW.sQIQQH4zzXkx4QRTcburUSq2TBxHfv4imWRkRk3BXcA=")
ki19.loginResult()
...
wait = {
    ...
    "comment1":"Auto Like By:✯тєαм ѕℓα¢ĸвσт✯\nline.me/ti/p/~fuck.you__\n\nOPEN ORDER тєαм ѕℓα¢ĸвσт\n\nSelfbot Only\nProtect 10 akun\nProtect 15 akun\nProtect 20 akun\nSb10 assist\nSb20 assist\nSb5 assist\nDll masih banyak\n\nMau nanya² pc owner nya ",
    "commentOn":False,
    "likeOn":True,
    "wcOn":True,
    "leftOn":True,
