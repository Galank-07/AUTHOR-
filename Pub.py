              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            ale.sendText(msg.to,"Admin ѕℓα¢ĸвσт Dihapus")
                        except:
                            pass
...
#              if msg.from_ in Admin:
		...
		if msg.from_ in admin:
		    ...
		    ale.sendText(msg.to, "Khusus Galank")
...
#--------------------------------------------------------
		...
		ale.sendText(msg.to,"Pasukan Absen!!")
                ale.sendText(msg.to,"ѕℓα¢ĸвσт1 Hadiir  \(ˆ▿ˆ)/")
                ale.sendText(msg.to,"ѕℓα¢ĸвσт2 Hadiir  \(ˆ▿ˆ)/")
                ale.sendText(msg.to,"ѕℓα¢ĸвσт3 Hadiir  \(ˆ▿ˆ)/")
                ale.sendText(msg.to,"Hadiir Semua Boss  \(ˆ▿ˆ)/")
                
                
            elif msg.text in ["Test","Tes"]:
		ale.sendText(msg.to,"Masuk boss")
                ale.sendText(msg.to,"Masuk ✍͡➴͜Ĝα₤αηĸ͜͡✫")
...
#-----------------------------------------------------
            ...
            elif "/cnsb" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/cnSb","Ganti Ale")
