...
╠❂͜͡➣ Add on/off
╠❂͜͡➣ Share on/off
╠❂͜͡➣ Message change:<Teks>
╠❂͜͡➣ Message check
╠❂͜͡➣ Up
╠❂͜͡➣ Spam @
╠❂͜͡➣ Woi/Taggall/Mention
╠❂͜͡➣ Gift
╠❂͜͡➣ Notifed on/off
╬═════════════════╬
...
#----------------------------------------------
		...
		ks.sendText(msg.to,(bctxt))
                ...
                kc.sendText(msg.to,"✮✮✮✮✮✮✮")
                ko.sendText(msg.to,"✮✮✮✮✮✮✮✮")
                cl.sendText(msg.to,"Hadir semua mastah!!!\nsiap terima perintah 😂😂\nDesah pun jadi mastah v:")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
              ...
              if msg.from_ in admin:      	
                start = time.time()
                cl.sendText(msg.to, "Sebentar Njing....")
