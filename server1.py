...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='Esl6NVCjrzJprkdcuTSc.EiU0U3H/ifOcEyRhHc8L+a.+P8Jz3MasLICM7LuIRdy+M+AYMJEKzaTqhfT0McTTaM=')
cl.loginResult()
...
ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EszFuC6egR565QqbpCy5.BLq7O8+KawO+e660v+4Ffq.73dvZPs3D0G2OkAaOs4u4OrR1Cg3Csxe1MX41ckCQKc=')
ki.loginResult()
...
kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Es3H1meGvDo3feFzt6E7.OV5wO6KNT/Aej4WCRimKTW.tNF+4wY1GQiECGfhGN4SPOGeG6NfTN09ZKc5PcEs0Kw=')
kk.loginResult()
...
kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EsUtodEp0fCsQjlvWnkc.IDk4goeKO5Cf02ymF6+K3a.GU4IeT30uMXMFdq/nJp4EMXrJQceG+fJZqtz/CsPyqY=')
kc.loginResult()
...
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EsncILpTrhESopVQbUwe.gCHBZ4Wg+A3q+6nb6neSdG.nGc9KQbnIZ/diEswAOIpPtU2Qb0NJ+L3EOMtg8qePrs=')
kr.loginResult()
...
km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='Es1gxtDz3ObG2l2gvIS3.opVfLAHd5WGf+bpOBpP3eW.so0campCXxfoI7U5feK8aAR36AdxU4vmBLynHYq5J2U=')
km.loginResult()
print "Km-Login Success\n\n=====[Sukses Team ✮Ŧ€Äm ÄυŦĦōя bōŦ✮ Login]====="
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 25:
			...
			cl.sendText(msg.to,"Admin Detected~")
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu Admin Creator Kami (ᴀᴜᴛʜᴏʀ ʙᴏᴛ)\nJomblo kok dia Boss\nNikung aja,siapa tau Jodoh :v😂")
                ...
                random.choice(KAC).sendMessage(msg)                
		random.choice(KAC).sendText(msg.to,"Itu Admin Kami (ᴀᴜᴛʜᴏʀ ʙᴏᴛ) (^_^)")	
...
#		    cl.sendText(msg.to,"Khusus UK.mora")
                ...
                if wait["Sambutan"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Datang Di Aktifkanヾ(*´∀｀*)ﾉ")
                else:
                    wait["Sambutan"] = True
                    wait["joinkick"] = False
                    if wait["lang"] == "JP":
            ...
            elif msg.text in ["Datang off"]:
                if wait["Sambutan"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Datang Di Nonaktifkan(　＾∇＾)")
                else:
                    wait["Sambutan"] = False
                    if wait["lang"] == "JP":
                ...
                md = ""
		if wait["Sambutan"] == True: md+="➩✔️ Datang : On\n"
		else:md+="➩❌ Datang : Off\n"
		...
		if wait["Simi"] == True: md+="➩✔️ Simisimi : On\n"
            ...
            elif msg.text in ["TB1 Gift","TB1 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["TB2 Gift","TB2 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["TB3 Gift","TB3 gift"]:
                msg.contentType = 9
		...
		if msg.from_ in Creator:
		    for i in gid:
			cl.sendText(i,"=======[BROADCAST]=======\n\n"+bc+"\n\nContact Me : line.me/ti/p/~Zibex05")
            ...
            elif msg.text in ["TB join","Join all"]:
		if msg.from_ in admin:
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"TB1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"TB2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"TB3 Hadiir  \(ˆ▿ˆ)/")
                kr.sendText(msg.to,"Hadiir Semua Boss  \(ˆ▿ˆ)/")
		...
		if msg.from_ in Creator:
            ...
            elif "TEAMBOT copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TEAMBOT copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = cl.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "TB1 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TB1 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ki.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                       ...
                       for target in targets:
                            try:
                               ...
                               ki.sendText(msg.to, "Copied (^_^)")
                                ...
                                print e
            elif "TB2 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TB2 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kk.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "TB3 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TB3 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kc.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "TB4 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("TB4 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kr.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                link = ["http://dl.profile.line.naver.jp/0hXvsxhibGB1lOASvpJe14DnJECTQ5LwERNmdAb2wDW25gMkNbJTNAOjtTCz1jYkELJzJKNzkAUWxi"]
            ...
            elif "/cnteambot" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/cnteambot","Chucky Kapten")
            ...
            elif "/cntb1" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntb1","Chucky TC1")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/cntb2" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntb2","Chucky TC2")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/cntb3" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntb3","Chucky TC3")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/cntb4" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/cntb4","Chucky TC4")
                    if len(string.decode('utf-8')) <= 5000:
                        profile = cl.getProfile()
                        profile.displayName = string
                        kr.updateProfile(profile)
...
#              if msg.from_ in admin:
            ...
            elif msg.text in ["TB acc invite"]:
                if msg.from_ in admin:
                    gid = cl.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["TB1 acc invite"]:
                if msg.from_ in admin:
                    gid = ki.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["TB2 acc invite"]:
                if msg.from_ in admin:
                    gid = kk.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["TB3 acc invite"]:
                if msg.from_ in admin:
                    gid = kc.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["TB4 acc invite"]:
                if msg.from_ in admin:
