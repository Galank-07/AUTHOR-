...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='Esx5gC4etLvQDxLM6N93.NmzuuaGINiHVaDgTB9Y8qW.wzS9gOvfwkXNNvcYcN9pMsbm7sRw+e9afElSFVaBink=')
nadya.loginResult()
...
Bots=[mid]
Creator=["u9cc6545008229c886f01d1ad6fdcbc43"]
admin=["u9cc6545008229c886f01d1ad6fdcbc43"]
