...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='EsIGMWEPxCdqrxk78C6e.mPzfT6jgemPnLCwsPSBVpG.oteiawDmeGmDYh9ke/HYJV8QO/nvcYHjpNBaNm3VyU8=')
nadya.loginResult()
...
Bots=[mid]
Creator=["u329645b7a24610ca4d95c592a6c6ef3e"]
admin=["u329645b7a24610ca4d95c592a6c6ef3e"]
