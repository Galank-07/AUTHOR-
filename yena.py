...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="Es23P7jTnOPtCSlFP5I0.gAyZyIlV6uRm4BbD05Wjqa.6FDkkFiVE0iTTI0ZJvClSorlSL/GKg0m7lWkrRpD3Bw=")
cl.loginResult()
...
kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token="EsqQlBQAmCIJ77sVcoAa.3svWLda5Jb1maVIdRVif6G.9uDHRSm/dtQYBDIMkL9YS/QuDDbVdHT2jMOMUbjrd+A=")
kk.loginResult()

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token="Es2fBI4HIJK0ZE1CnYF8.LetmZ3b3S8xsvXte6ExxAa.w/8pzNI8R6lKc8rWlTN0hdOh89qLeRz5AP59rPAKck0=")
kc.loginResult()

kd = LINETCR.LINE()
#kd.login(qr=True)
kd.login(token="EsRHNl6pHgXTB5WgNY5a.WQ7xJwYTy17gLrjSzVBpMG.7FB2mWiovQzMJugEACLy/Tzr3DDsD4KcTnzc1ObnOv8=")
kd.loginResult()

ke = LINETCR.LINE()
#ke.login(qr=True)
ke.login(token="Es7Ti084CA7Wny0PvEM8.yShUITzJjuINW9CsoWQVca.mjf3ZQBsH167+STFdaGUqP7vPVc3t55m+t9DSbuc5FA=")
ke.loginResult()

kf = LINETCR.LINE()
#kf.login(qr=True)
kf.login(token="EssU2QiQHOyzelXqrI61.ccBRnlJ52qxGddbmnGz+iq.O5UqBd2IM7JrNaXWc0+Kus/JaFQNM2mh4W4SrOwsstY=")
kf.loginResult()

kg = LINETCR.LINE()
#kg.login(qr=True)
kg.login(token="EsuCrqMcDR9Hbto1FkV7.ZCgQGGMRGrx9nKkkfuo+rW.rx2Mkb+E/UeucaJue3I6/3aFB7wajISt6kismB3X+Mw=")
kg.loginResult()

kh = LINETCR.LINE()
#kh.login(qr=True)
kh.login(token="EssEHm4VGr4kFiTyK4B6.Dv033ExVwtRzpkmQ3JkPDG.eUfNB+t48lJUXiPfnYyuigsy9ShZYFIdAHUeL/njAj4=")
kh.loginResult()

kj = LINETCR.LINE()
#kj.login(qr=True)
kj.login(token="EsoKj1rRJkJqqkAphZpb.qaw5y8Mf18Zg7MWUSHAtEW.mJBGXQjsTqQ9RF47r4Td1Fo9UrZe2OmbBV8JfI+GiFM=")
kj.loginResult()

kl = LINETCR.LINE()
#kl.login(qr=True)
kl.login(token="EsefdNFrE3J7sX3wJfRf.8/vGPiBoM/ZcB4S2oYc0tW.XVh3QkDpdg90DOoYfKroL+OHTtGX1pGDky3+zMcGDu4=")
kl.loginResult()

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token="EsFiTiWDVddGrH7zFktd.Dkl2Q0fRgrXp4R0cbpdBpq.zYjYJOsbhJ/7TZ9tLPZTW2MuhEOztD5ctRkxWvHas7E=")
km.loginResult()
...
#	      if msg.from_ in Creator:
                ...
                if wait["winvite"] == True: md+="��❂͜͡🕵️➣Invite : → ✔\n"
                else:md+="��❂͜͡🕵️➣Invite : → ❌\n"
                if wait["pname"] == True: md+="��❂͜͡🕵️➣Namelock : → ✔\n"
                else:md+="��❂͜͡🕵️➣Namelock : → ❌\n"
                if wait["contact"] == True: md+="��❂͜͡🕵️➣Contact : → ✔\n"
                else: md+="��❂͜͡🕵️➣Contact : → ❌\n"
                if wait["autoJoin"] == True: md+="��❂͜͡🕵️➣Auto join : → ✔\n"
                else: md +="��❂͜͡🕵️➣Auto join : → ❌\n"
                if wait["autoCancel"]["on"] == True:md+="��❂͜͡🕵️➣Group cancel :" + str(wait["autoCancel"]["members"]) + " → ✔\n"
                else: md+= "��❂͜͡🕵️➣Group cancel : → ❌\n"
                if wait["leaveRoom"] == True: md+="��❂͜͡🕵️➣Auto leave : → ✔\n"
                else: md+="��❂͜͡🕵️➣Auto leave : → ❌\n"
                if wait["timeline"] == True: md+="��❂͜͡🕵️➣Share : → ✔\n"
                else:md+="��❂͜͡🕵️➣Share : → ❌\n"
                if wait["clock"] == True: md+="��❂͜͡🕵️➣Clock Name : → ✔\n"
                else:md+="��❂͜͡🕵️➣Clock Name : → ❌\n"
                if wait["autoAdd"] == True: md+="��❂͜͡🕵️➣Auto add : → ✔\n"
                else:md+="��❂͜͡🕵️➣Auto add : → ❌\n"
                if wait["alwaysRead"] == True: md+="��❂͜͡🕵️➣Always Read : → ✔\n"
                else:md+="��❂͜͡🕵️➣Always Read : → ❌\n"
                if wait["Wc"] == True: md+="��❂͜͡🕵️➣WELCOME : → ✔\n"
                else:md+="��❂͜͡🕵️➣WELCOME : → ❌\n"
                if wait["Lv"] == True: md+="��❂͜͡🕵️➣LEAVE : → ✔\n"
                else:md+="��❂͜͡🕵️➣LEAVE : → ❌\n"
                if wait["tag"] == True: md+="��❂͜͡🕵️➣TAG 1 : → ✔\n"
                else:md+="��❂͜͡🕵️➣TAG 1 : → ❌\n"
                if wait["tag2"] == True: md+="��❂͜͡🕵️➣TAG 2 : → ✔\n"
                else:md+="��❂͜͡🕵️➣TAG 2 : → ❌\n"
                if wait["Sider"] == True: md+="��❂͜͡🕵️➣Auto Sider : → ✔\n"
                else:md+="��❂͜͡🕵️➣Auto Sider : → ❌\n"
                if wait["Simi"] == True: md+="��❂͜͡🕵️➣Simisimi : → ✔\n"
                else:md+="��❂͜͡🕵️➣Simisimi : → ❌\n"
                if wait["commentOn"] == True: md+="��❂͜͡🕵️➣Comment : → ✔\n"
                else:md+="��❂͜͡🕵️➣Comment : → ❌\n"
#                if wait["AutoKick"] == True: md+="��❂͜͡🕵️➣AutoKick : → ✔\n"
#                else:md+="��❂͜͡🕵️➣AutoKick : → ❌\n"
#                if wait["protectionOn"] == True: md+="��❂͜͡🕵️➣Protection : → ✔\n\n"+ datetime.today().strftime('%H:%M:%S')
#                else:md+="��❂͜͡🕵️➣Protection : → ❌\n\n"+ datetime.today().strftime('%H:%M:%S')
